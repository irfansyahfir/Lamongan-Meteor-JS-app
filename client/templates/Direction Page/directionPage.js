...
Template.mapDirection.helpers({
                              mapDirectionSetOptions: function() {
...
Template.mapDirection.onCreated(function() {
                                ...
                                GoogleMaps.ready('mapDirectionSet', function(map) {
...
/*Template.mapDirection.onRendered(function(){
    ...
    function calcRoute() {
        ...
        if(navigator.geolocation) {
            navigator.geolocation.getCurrentPosition(function(position) {
                                                     var start = new google.maps.LatLng(-6.8827199,112.271004);
                                                     var end = new google.maps.LatLng(-6.978902,112.28871);;
                                                     var request = {
                                                     origin: start,
                                                     destination:end,
